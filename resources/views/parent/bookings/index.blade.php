                ...
                <div class="table-responsive">
                    <table class="table table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                            <tr>
                                <td colspan="3" class="text-center text-muted py-3">No hospitals available.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
...
childSelect.addEventListener('change', function () {
    ...
    fetch(`/parent/api/booked-vaccines/${childId}`)
        .then(res => res.json())
        .then(booked => {

            [...vaccineSelect.options].forEach(option => {

                if (booked.includes(parseInt(option.value))) {
