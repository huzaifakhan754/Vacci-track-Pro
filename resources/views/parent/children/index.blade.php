...
@section('content')
<!-- 🔥 Premium Light-Mode Glassmorphism Styles for Children Cards -->
<style>
    :root {
    ...
    /* Gender Pill Badge */
    .gender-pill-boy { background: #e0f2fe; border: 1px solid #bae6fd; color: #0369a1; }
    .gender-pill-girl { background: #fce7f3; border: 1px solid #fbcfe8; color: #be185d; }
    .gender-pill-default { background: #f1f5f9; border: 1px solid #e2e8f0; color: #475569; }
    ...
    .info-label .icon-dob { background: #fef3c7; color: #d97706; }
    .info-label .icon-blood { background: #fee2e2; color: #dc2626; }
    ...
    .btn-action {
        ...
        border-radius: 14px; font-size: 13px; font-weight: 600; transition: all 0.25s ease;
...
<div class="py-3">
    ...
    <div class="d-flex justify-content-between align-items-start mb-5 flex-wrap gap-3">
        <div>
            <h1 class="fw-bold mb-1" style="font-family: 'Space Grotesk', sans-serif; font-size: 28px; color: #0f172a;">My Children</h1>
            <p class="text-muted mb-0" style="font-size: 14px; color: #475569;">Add and manage your children's vaccination details.</p>
        </div>
        <a href="{{ route('parent.children.create') }}" class="apex-btn-primary d-inline-flex align-items-center gap-2 text-decoration-none shadow-sm" style="border-radius: 12px; padding: 10px 20px; font-weight: 600;">
            ...
            <div class="col-md-6 col-xl-4">
                <article class="child-card p-4 h-100 d-flex flex-column shadow-sm bg-white">
                    ...
                    <div class="row g-2 mt-auto pt-2">
                        <!-- Edit Button Link -->
                        <div class="col-6">
                            <a href="{{ route('parent.children.edit', $child) }}" class="btn-action btn btn-outline-primary" style="border-radius: 14px;">
                        ...
                        <div class="col-6">
                            <form action="{{ route('parent.children.destroy', $child) }}" method="POST" class="w-100"
                                  onsubmit="return confirm('Are you sure you want to remove this child profile?');">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn-action btn btn-outline-danger" style="border-radius: 14px;">
